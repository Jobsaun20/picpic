...
notifications: {
  ...
  fine_received: {
    ...
    icon: "💸",
    message: '{{sender}} hat dir eine Busse von {{amount}} CHF für "{{reason}}" geschickt',
  },
  challenge_created: {
...
fineReceivedBody: "Du hast eine Busse von {{sender}} über {{amount}} CHF erhalten. Grund: {{reason}}",
...
showInstallBanner: "Für die Installation auf iOS: Tippe auf „Teilen“ 📤 und wähle „Zum Home-Bildschirm hinzufügen“ aus.",
    phoneWarning: "Füge deine Telefonnummer hinzu, um Zahlungen mit TWINT zu erhalten. KEINE SORGE! Nur derjenige, der deine Busse erhält, kann sie sehen.",
...
created: "erstellt",
  ...
  createFine: {
    ...
    sentTo: "Busse über {amount} CHF an {recipient} gesendet",
  ...
  // Payment Modal
  payment: {
    title: "Busse bezahlen - {amount} CHF",
    description: "Bezahlen Sie Ihre Busse mit TWINT, indem Sie den QR-Code scannen oder die Nummer verwenden",
  ...
  pages: {
    ...
    notifications: {
      ...
      fine_received: "{{sender}} hat dir eine Busse von {{amount}} CHF für \"{{reason}}\" gesendet",
      fine_received_title: "Busse erhalten",
      payment_received: "{{sender}} hat deine Busse von {{amount}} CHF bezahlt",
...
note: "• Busse: wird bei Regelverstoss versendet.\n • Challenge: zeitlich begrenzte Herausforderungen, vorgeschlagen an einen oder mehrere Kontakte."
  ...
  modal: {
    ...
    addTelephoneNumber: "Gib deine Telefonnummer für TWINT ein",
